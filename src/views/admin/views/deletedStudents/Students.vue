<template>
  <v-container>
    <v-row>
      <v-col
        v-for="(student, i) in allDeletedStudents"
        :key="i"
        cols="12"
        sm="6"
        md="4"
      >
        <v-card class="rounded-lg">
            ...
            >
              <v-list-item color="transparent" class="px-0">
                <template v-slot:prepend>
                  <v-badge
                    dot
                    :color="student?.verified ? 'green' : 'red-darken-4'"
                  >
                    <v-avatar>
          ...
          <v-card-text class="mt-0 pt-0">
            <v-row dense>
              <v-col cols="12">
                <span class="text-caption font-weight-regular font-weight-bold">
                  course One
                </span>
              </v-col>
              <v-col cols="4">
                <span class="text-caption font-weight-regular"> course: </span>
              </v-col>
              <v-col cols="8">
          ...
          <v-card-actions>
            <v-btn
              :to="`/admin/deletedStudents/${student?.id}`"
              block
