        ...
        >
          ...
          <v-toolbar-items>
            ...
            <v-btn @click="deleteStudent" :loading="deleteLoading">
              ...
              <span class="text-capitalize text-red">{{
                student?.status == "deleted" ? "Undo Delete" : "Delete"
              }}</span>
            </v-btn>
            <v-btn>
...
export default {
  ...
  methods: {
    ...mapActions(["fetchStudents", "fetchDeletedStudents"]),
    ...
    async deleteStudent() {
      if (this.student?.status != "deleted") {
        ...
        this.deleteLoading = false;
        this.snackbar.active = true;
        this.snackbar.text = "Student delete successfully Undone";
        this.snackbar.color = "success";
        this.getStudent();
        this.fetchStudents();
        this.fetchDeletedStudents();
